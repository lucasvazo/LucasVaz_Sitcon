    ...
    return (
        <button 
            ...
            className={
                ...
                rounded-[12px] py-3 px-10 text-sm active:translate-y-[1px] hover:shadow-md leading-4
                active:brightness-100 font-semibold text-[1rem] hover:brightness-90 active:shadow-none ${buttonVariants[variant]} 
                disabled:text-stc-white disabled:bg-gray-300 hover:disabled:brightness-100 hover:disabled:translate-y-[0px]
                hover:disabled:shadow-none flex items-center`
            }>
            {title}
        </button>
    );
